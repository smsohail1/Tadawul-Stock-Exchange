...
//	public static final String DB_Path = Environment.getDataDirectory()
  //          .getAbsolutePath() + "/databases/";
    public static final String DB_Path =  "/data/data/com.appinhand.saudistockexchangepaid/databases/";
//    public static final String DATABASE_NAME = "test_db";
	public static final String DATABASE_TABLE = "stocks_kse";
	public static final String DATABASE_TABLE_NOTIFY = "notification";


	public static final int DATABASE_VERSION = 1;


	public  static String KEY_CURRENT_WEB="currentservice";
	public static String KEY_GTR_LSR = "greaterlesser";
	public static String KEY_CURRENT = "currentuser";
